...
export const KO_ACCOUNTS_MESSAGES: MessageCatalog = {
  ...
  "批量关闭账号": "계정 일괄 비활성화",
  "批量状态": "일괄 상태",
  "批量开启选中账号": "선택 계정 일괄 활성화",
  "批量关闭选中账号": "선택 계정 일괄 비활성화",
  "请先选择账号": "먼저 계정을 선택하세요",
  "当前选中账号没有可开启项": "선택한 계정 중 활성화할 항목이 없습니다",
  "当前选中账号没有可关闭项": "선택한 계정 중 비활성화할 항목이 없습니다",
  "批量{action}完成：成功{success}个，失败{failed}个，跳过{skipped}个":
    "일괄 {action} 완료: 성공 {success}개, 실패 {failed}개, 건너뜀 {skipped}개",
  "批量{action}完成：成功{success}个，失败{failed}个":
    "일괄 {action} 완료: 성공 {success}개, 실패 {failed}개",
  "批量{action}完成：成功{success}个，跳过{skipped}个":
    "일괄 {action} 완료: 성공 {success}개, 건너뜀 {skipped}개",
  "批量{action}完成：成功{success}个":
    "일괄 {action} 완료: 성공 {success}개",
  "批量{action}失败: {error}": "일괄 {action} 실패: {error}",
  "测试账号": "계정 테스트",
  "测试类型": "테스트 유형",
  "选择测试类型": "테스트 유형 선택",
  "文字模型": "텍스트 모델",
  ...
  "已取消测试，可再次点击「开始测试」。":
    "테스트가 취소되었습니다. 테스트 시작을 눌러 다시 실행할 수 있습니다.",
  "准备就绪，点击「开始测试」发起一次真实请求。":
    "준비되었습니다. 테스트 시작을 눌러 실제 요청을 보내세요.",
  "模型：": "모델: ",
  "测试成功": "테스트 성공",
  "该账号为手动禁用，测试虽成功但不会被自动恢复为「可用」。":
    "이 계정은 수동으로 비활성화되어 있어 테스트가 성공해도 자동으로 사용 가능 상태로 복원되지 않습니다.",
  "图片预览": "이미지 미리보기",
  "开始测试": "테스트 시작",
  "启动测试失败": "테스트를 시작하지 못했습니다",
  "预计删除": "예상 삭제",
};
