...
export const EN_DASHBOARD_MESSAGES: MessageCatalog = {
  ...
  运行中: "Running",
  刷新中: "Refreshing",
  "实时 IP 请求": "Live IP requests",
  实时请求读取失败: "Failed to load live requests",
  "请确认本地服务在线，并且当前账号拥有管理员权限。":
    "Make sure the local service is online and the current account has administrator permissions.",
  当前运行中: "Running now",
  "当前没有运行中或排队中的请求":
    "No running or queued requests right now",
  "客户端 IP": "Client IP",
  "未知 IP": "Unknown IP",
  "模型 / 路径": "Model / path",
  等待: "Wait",
  "等待 / 运行": "Wait / run",
  正在读取实时请求: "Loading live requests",
  没有匹配的实时请求: "No matching live requests",
  默认分组: "Default group",
  未知状态: "Unknown status",
  现在: "Now",
  检查设置: "Check settings",
